...
<form name="form1" id="form1" action = "Altera_CliJ_Banco2.jsp?user=<%= user%>&agencia=<%=agencia%>&razao=<%=razao%>&cnpj=<%=cnpj%>&inscri=<%=inscri%>" method = "post">	
	...
	<h1><P align="center">Alteração de Pessoa Jurídica</h1></P>
	...
	<tr>
		<td><face="arial" size="12"><center>Data de Emissão</><br><INPUT TYPE="text" name="dataemcnh" id="dataemcnh" maxlength="10" value=<%= emiscnh%> ></center></td>
