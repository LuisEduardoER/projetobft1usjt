...
if(rs.next())
{
	...
	response.sendRedirect("Deleta_Vei.jsp?user="+user+"&agencia="+agencia+"&codigo="+codigo+"&chassi="+chassi+"&placa="+placa+"&modelo="+modelo+
...
else
{
	...
	response.sendRedirect("Deleta_Veiculo.jsp?user="+user+"&agencia="+agencia+"&idi="+idi);
}
