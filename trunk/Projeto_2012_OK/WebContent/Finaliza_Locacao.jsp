...
<form name="form1" id="form1" action="Finaliza_Loc_Banco.jsp?user=<%= user%>&agencia=<%=agencia%>&idi=<%= idi%>" method = "post">

	<h1><P align="center"><label data-bind="text: finalizaloc"></label></h1></P>
	<face="arial" size="12">
