...
<form name="form1" id="form1" action = "Deleta_CliJ_Banco2.jsp?user=<%= user%>&agencia=<%=agencia%>&cnpj=<%=cnpj%>&idi=<%=idi %>" method = "post">	


	<h1><P align="center"><label data-bind="text: delpj"></label></h1></P>
