...
<form name="form1" id="form1" action = "Deleta_Vei_Banco2.jsp?user=<%= user%>&agencia=<%=agencia%>&idi=<%=idi%>" method = "post">

	<h1><P align="center"><label data-bind="text: delvei"></label></h1></P>
	...
	<BR>
	<BR>
	<center>	<face="arial" size="12"><center><label data-bind="text: delvei2"></label></><BR><BR>
