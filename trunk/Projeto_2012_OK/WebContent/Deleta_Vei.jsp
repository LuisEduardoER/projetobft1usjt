...
<form name="form1" id="form1" action = "Deleta_Vei_Banco2.jsp?user=<%= user%>&agencia=<%=agencia%>" method = "post">
	...
	<BR>
	<BR>
	<center>	<face="arial" size="12"><center>Deseja Excluir Esse Veículo ?</><BR><BR>
