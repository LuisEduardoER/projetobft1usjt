...
<title>Excluir Pessoa Jurídica</title>

</head>
<body text="#000000">

<form name="form1" id="form1" action = "Deleta_CliJ_Banco2.jsp?user=<%= user%>&agencia=<%=agencia%>&cnpj=<%=cnpj%>" method = "post">	


	<h1><P align="center">Exclusão de Pessoa Jurídica</h1></P>
	<face="arial" size="20"><center>Dados Básico</center><P>
	<center><table border = "0">
	<tr>
		<td COLSPAN = 2 ><face="arial" size="12"><center>Nome Fantasia</><br><INPUT TYPE="text" name="nome" size="40" VALUE="<%= nome%>" disabled></center></td>
	...
	<tr>
		<td COLSPAN = 2 ><face="arial" size="12"><center>Razão Social</><br><INPUT TYPE="text" name="razao" size="40" VALUE="<%= razao%>" disabled></center></td>
		...
		<td COLSPAN = 2 ><face="arial" size="12"><center>Inscrição Estadual</><br><INPUT TYPE="text" name="inscri" maxlength="40" size="40" VALUE=<%= inscri%> disabled></center></td>
	</tr>
	</table>
	<br><br>
	...
	<tr>
		<td><face="arial" size="12"><center>Nome</><br><INPUT TYPE="text" name="nome" size="40" VALUE="<%= nomecond%>" disabled></center></td>
		<td><face="arial" size="12"><center>CPF</><br><INPUT TYPE="text" name="cpf" id="cpf" maxlength="16" value=<%= cpf%> disabled></center></td>
		<td><face="arial" size="12"><center>RG</><br><INPUT TYPE="text" name="rg" id="rg" maxlength="12" value=<%= rg%> disabled></center></td>
	</tr>
	<tr>
