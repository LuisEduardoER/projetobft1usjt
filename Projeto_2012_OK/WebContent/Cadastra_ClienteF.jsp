...
<form name="form1" id="form1" action = "Cadastra_CliF_Banco.jsp?user=<%= user%>&agencia=<%=agencia%>" method = "post">	
	...
	<h1><P align="center">Cadastro de Pessoa Física</h1></P>
	<face="arial" size="20"><center>Cadastro Básico</center><P>
	<center><table border = "0">
	<tr>
		<td COLSPAN = 2 ><face="arial" size="12"><center>Nome</><br><INPUT TYPE="text" name="nome" maxlength="40" size="40" VALUE=""></center></td>
